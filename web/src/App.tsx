                ...
                <div className="flex gap-6">
                  <div className="flex flex-col gap2">
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      <button className="w-8 h-8  bg-zinc-900">D</button>
                      <button className="w-8 h-8  bg-zinc-900">S</button>
                      <button className="w-8 h-8  bg-zinc-900">T</button>
                      <button className="w-8 h-8 bg-zinc-900 ">Q</button>
                      <button className="w-8 h-8  bg-zinc-900">Q</button>
                      <button className="w-8 h-8  bg-zinc-900">S</button>
                      <button className="w-8 h-8  bg-zinc-900">S</button>
                    </div>
